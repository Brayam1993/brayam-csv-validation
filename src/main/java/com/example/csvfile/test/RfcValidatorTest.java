...
import com.example.csvfile.validators.RfcValidator;
...
class RfcValidatorTest {
    ...
    private static Line getLine(String rfc) {
        return new Line(1, null, null, rfc, null, null, null, null,null);
    }
    ...
    void validate_whenDuplicatedRfc_receiveViolation() {
        ...
        final Line line1 = new Line(1,null,null,"RFC1234567890",null,null,null,null,null);
        final Line line2 = new Line(2,null,null,"RFC1234567890",null,null,null,null,null);
